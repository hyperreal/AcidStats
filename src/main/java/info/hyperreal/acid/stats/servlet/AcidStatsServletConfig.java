...
import info.hyperreal.acid.stats.servlet.filters.AuthorizationFilter;
    ...
    protected Injector getInjector() {
        return Guice.createInjector(new ServletModule() {
            ...
            private Map<String, String> getServletParams() {
                ...
                params.put("com.sun.jersey.spi.container.ContainerRequestFilters", "info.hyperreal.acid.stats.servlet.filters.AuthorizationFilter");
